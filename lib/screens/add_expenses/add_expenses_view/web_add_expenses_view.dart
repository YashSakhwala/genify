...
class WebAddExpensesScreen extends StatefulWidget {
  const WebAddExpensesScreen({super.key});

  @override
  State<WebAddExpensesScreen> createState() => _WebAddExpensesScreenState();
}

class _WebAddExpensesScreenState extends State<WebAddExpensesScreen> {
