...
class WebAllTransactionScreen extends StatefulWidget {
  const WebAllTransactionScreen({super.key});

  @override
  State<WebAllTransactionScreen> createState() =>
      _WebAllTransactionScreenState();
}

class _WebAllTransactionScreenState extends State<WebAllTransactionScreen> {
