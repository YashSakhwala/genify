// ignore_for_file: prefer_const_constructors, sort_child_properties_last, unnecessary_to_list_in_spreads, deprecated_member_use, sized_box_for_whitespace

import 'package:animate_do/animate_do.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:genify/screens/home_screen_option/income_view/income_make_function.dart';
...
class WebIncomeView extends StatefulWidget {
  const WebIncomeView({super.key});

  @override
  State<WebIncomeView> createState() => _WebIncomeViewState();
}

class _WebIncomeViewState extends State<WebIncomeView> {
                        ...
                        child: Column(
                          children: [
                            ...
                            ...revenues.asMap().entries.map((entry) {
                              ...
                              Map<String, TextEditingController> revenue =
                                  entry.value;
                              return Padding(
                            ...
                            ...expenses.asMap().entries.map((entry) {
                              ...
                              Map<String, TextEditingController> expense =
                                  entry.value;
                              return Padding(
                                padding: const EdgeInsets.only(bottom: 15),
                                child: Row(
                            ...
                            ...otherExpenses.asMap().entries.map((entry) {
                              ...
                              Map<String, TextEditingController> otherExpense =
                                  entry.value;
                              return Padding(
                                padding: const EdgeInsets.only(bottom: 15),
                                child: Row(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...cgs.asMap().entries.map((entry) {
                              ...
                              Map<String, TextEditingController> cogs =
                                  entry.value;
                              return Padding(
                                padding: const EdgeInsets.only(bottom: 15),
                                child: Row(
                            ...
                            ...otherIncomes.asMap().entries.map((entry) {
                              ...
                              Map<String, TextEditingController> otherIncome =
                                  entry.value;
                              return Padding(
                                padding: const EdgeInsets.only(bottom: 15),
                                child: Row(
                            ...
                            Obx(
                              () => Column(
                                children: [
                                  ...
                                  incomeController.taxValue.value == 1 ||
