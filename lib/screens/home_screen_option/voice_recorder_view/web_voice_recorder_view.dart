...
// class WebVoiceRecorderScreen extends StatefulWidget {
//   const WebVoiceRecorderScreen({Key? key}) : super(key: key);

//   @override
//   _WebVoiceRecorderScreenState createState() => _WebVoiceRecorderScreenState();
// }

// class _WebVoiceRecorderScreenState extends State<WebVoiceRecorderScreen> {
...
//   void downloadRecording(String filePath, String fileName) {
//     html.AnchorElement anchorElement = new html.AnchorElement(href: filePath);
...
//                         await record.stop();
//                         if (kIsWeb) {
//                           // String blobUrl = await record.path();
//                           // downloadRecording(blobUrl, savName.text);
//                         } else {
//                           String musicDir = await ExternalPath
//                               .getExternalStoragePublicDirectory(
//                                   ExternalPath.DIRECTORY_DOWNLOADS);
...
//                           File file = File(folder.path);
//                           File saveFile =
//                               File("${folder2.path}/${savName.text}");
